...
| Op | Command |
|----|---------|
| **dream-report** (default `/code-dreaming`) | `python3 BASE/scripts/dream_agent_report.py --repo-root REPO [--memory-dir DIR] [--trajectory PATH] [--instructions TEXT] [--output-mode native\|project-root] [--out-dir DIR] [--keep N]` |
